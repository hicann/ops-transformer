...
/*!
 * \file grouped_matmul_swiglu_quant_utils_kernel.h
 * \brief
 */
#ifndef ASCENDC_GROUPED_MATMUL_SWIGLU_QUANT_UTILS_KERNEL_H
#define ASCENDC_GROUPED_MATMUL_SWIGLU_QUANT_UTILS_KERNEL_H
