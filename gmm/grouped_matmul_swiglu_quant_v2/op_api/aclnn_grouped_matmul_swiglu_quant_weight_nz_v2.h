 ...
 *
 * @param [in] x:
 * 表示公式中的x，数据类型支持INT8、INT4、INT32、FLOAT4_E1M2、FLOAT4_E2M1、FLOAT8_E4M3FN、HIFLOAT8数据类型，数据格式支持ND。
 * @param [in] weight:
 * 表示公式中的weight，数据类型支持INT8、INT4、INT32、FLOAT4_E1M2、FLOAT4_E2M1、FLOAT8_E4M3FN、HIFLOAT8数据类型，数据格式支持NZ。
 ...
 * 表示平滑缩放因子，用于在量化前对SwiGLU计算结果进行缩放，数据类型支持FLOAT32数据类型，数据格式支持ND。
 ...
 * @param [in] tuningConfigOptional: 用于算子预估m/e的大小，走不同的算子模板，以适配不同场景性能要求。
 * @param [out] output:
 * 表示公式中的out，数据类型支持INT8、FLOAT8_E4M3FN、FLOAT4_E2M1、FLOAT4_E1M2数据类型，数据格式支持ND。
 * @param [out] outputScale: 表示公式中的outQuantScale，数据类型支持FLOAT32、FLOAT8_E8M0数据类型。
