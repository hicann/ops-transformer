 ...
 * 表示量化参数中的偏移量，数据类型支持FLOAT32数据类型，数据格式支持ND，支持的最大长度为128个。
 ...
 * @return aclnnStatus: 返回状态码。
 */
__attribute__((visibility("default"))) aclnnStatus aclnnGroupedMatmulV5(void *workspace, uint64_t workspaceSize,
