...
template <uint32_t PRELOAD_STAGES_, uint32_t L1_STAGES_, uint32_t L0A_STAGES_, uint32_t L0B_STAGES_,
          uint32_t L0C_STAGES_, bool ENABLE_UNIT_FLAG_, bool ENABLE_RIFFLE_SHUFFLE_, class L1TileShape_,
          class L0TileShape_, class AType_, class BType_, class CType_, class BiasType_, class TileCopy_,
          class TileMmad_>
struct BlockMmad<MmadAtlasA2PreloadAsyncWithCallbackPerGroup<PRELOAD_STAGES_, L1_STAGES_, L0A_STAGES_, L0B_STAGES_,
                                                             L0C_STAGES_, ENABLE_UNIT_FLAG_, ENABLE_RIFFLE_SHUFFLE_>,
                 L1TileShape_, L0TileShape_, AType_, BType_, CType_, BiasType_, TileCopy_, TileMmad_> {
public:
    // Type Aliases
    using DispatchPolicy =
        MmadAtlasA2PreloadAsyncWithCallbackPerGroup<PRELOAD_STAGES_, L1_STAGES_, L0A_STAGES_, L0B_STAGES_, L0C_STAGES_,
...
private:
    ...
    void InitL1(Arch::Resource<ArchTag> &resource, uint32_t l1BufAddrStart)
    {
        ...
        for (uint32_t i = 0; i < L1_STAGES; ++i) {
            ...
            l1ScaleTensorList[i] =
                resource.l1Buf.template GetBufferByByte<ElementScale>(l1ScaleOffset + L1SCALE_TILE_SIZE * i);
