...
// S8S4 BasicApi keeps one 256-element quant group in each fixed MTE2 K window.
#define WQGMM_S8S4_FIXED_TEMPLATE WQGMM_MTE2_INNER_SIZE_256_BUF_NUM_2
...
ASCENDC_TPL_SEL(
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(W_TYPE, ASCENDC_TPL_UI_LIST, WQGMM_ND, WQGMM_FRACTAL_NZ),
        ASCENDC_TPL_UINT_SEL(OFFSET_OR_BIAS_EXIT, ASCENDC_TPL_UI_LIST,
                            WQGMM_ANTIQUANT_OFFSET_NOT_EXIST_BIAS_NOT_EXIST),
        ASCENDC_TPL_UINT_SEL(C_QUANT_TYPE, ASCENDC_TPL_UI_LIST, WQGMM_PER_CHANNEL, WQGMM_PER_GROUP),
        ASCENDC_TPL_UINT_SEL(W_QUANT_TYPE, ASCENDC_TPL_UI_LIST, WQGMM_NONE),
        ...
        ASCENDC_TPL_UINT_SEL(TEMPLATE_CUSTOM_SC, ASCENDC_TPL_UI_LIST, WQGMM_S8S4_FIXED_TEMPLATE),
        ASCENDC_TPL_BOOL_SEL(IS_SINGLE_MULTI_SINGLE, WQGMM_NOT_SINGLE_MULTI_SINGLE),
        ASCENDC_TPL_UINT_SEL(ALGORITHM_SUB_CATEGORY, ASCENDC_TPL_UI_LIST, WQGMM_VDEFAULT),
        ASCENDC_TPL_UINT_SEL(ALGORITHM_CATEGORY, ASCENDC_TPL_UI_LIST, WQGMM_MULTI_SCALE_DEQUANT))
);
#else
ASCENDC_TPL_SEL(
    ASCENDC_TPL_ARGS_SEL(
