...
KcQuantMatmulAlltoAllHelper::KcQuantMatmulAlltoAllHelper(
    ...
    : Mc2AdaptiveSlidingWindowTiling(kcQuantMatmulAllToAllTilingBase.context_, &out),
...
CutResult KcQuantMatmulAllToAllTilingBase::GetTilingResult()
{
    ...
    return GetArch35TilingResult(contextInfo.args_, KernelType::ALL_TO_ALL, npuArch_, QuantMode::KC_QUANT, commMode);
}
