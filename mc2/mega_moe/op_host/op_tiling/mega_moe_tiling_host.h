...
/*!
 * \file mega_moe_tiling_host.h
 * \brief
 */

#ifndef MEGA_MOE_TILING_HOST_TILING
#define MEGA_MOE_TILING_HOST_TILING
...
struct MegaMoeConfig {
    ...
    uint32_t attrSharedExpertQuantOutDtypeIndex = 6U;
    uint32_t attrCombineQuantModeIndex = 7U;
    uint32_t attrCommAlgIndex = 8U;
    uint32_t attrNumMaxTokensPerRankIndex = 9U;
    uint32_t attrActivationIndex = 10U;
    uint32_t attrActivationParamsIndex = 11U;
    uint32_t attrActivationOutDtypeIndex = 12U;
    uint32_t attrTransposeWeight1Index = 13U;
    uint32_t attrTransposeWeight2Index = 14U;
    uint32_t attrWeight1InterleaveIndex = 15U;
