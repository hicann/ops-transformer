...
#ifndef CATLASS_MEGA_MOE_GEMM_HELPER_HPP
#define CATLASS_MEGA_MOE_GEMM_HELPER_HPP
...
struct TileShapeAlignChecker {
    static constexpr uint32_t ALIGN_BITS = _aligned * 8;

    static_assert(L1TileShape::M * SizeOfBits<ElementA>::value % ALIGN_BITS == 0, "L1TileShape::M is not aligned.");
    static_assert(L0TileShape::M * SizeOfBits<ElementA>::value % ALIGN_BITS == 0, "L0TileShape::M is not aligned.");
    static_assert(L1TileShape::K * SizeOfBits<ElementA>::value % ALIGN_BITS == 0, "L1TileShape::K is not aligned.");
    static_assert(L1TileShape::K * SizeOfBits<ElementB>::value % ALIGN_BITS == 0, "L1TileShape::K is not aligned.");
    static_assert(L0TileShape::K * SizeOfBits<ElementA>::value % ALIGN_BITS == 0, "L0TileShape::K is not aligned.");
    static_assert(L0TileShape::K * SizeOfBits<ElementB>::value % ALIGN_BITS == 0, "L0TileShape::K is not aligned.");
    static_assert(L1TileShape::N * SizeOfBits<ElementB>::value % ALIGN_BITS == 0, "L1TileShape::N is not aligned.");
    static_assert(L0TileShape::N * SizeOfBits<ElementB>::value % ALIGN_BITS == 0, "L0TileShape::N is not aligned.");
};

///////////////////////////////////////
} // namespace Catlass::Gemm::helper

#endif // CATLASS_MEGA_MOE_GEMM_HELPER_HPP
