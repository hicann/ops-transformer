...
#ifndef CATLASS_MEGA_MOE_EPILOGUE_DISPATCH_POLICY_HPP
#define CATLASS_MEGA_MOE_EPILOGUE_DISPATCH_POLICY_HPP
...
#endif // CATLASS_MEGA_MOE_EPILOGUE_DISPATCH_POLICY_HPP
