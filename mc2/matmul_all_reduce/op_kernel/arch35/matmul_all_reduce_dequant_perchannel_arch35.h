...
/*!
 * \file matmul_all_reduce_dequant_perchannel_arch35.h
 * \brief
 */

#ifndef MATMUL_ALL_REDUCE_DEQUANT_PERCHANNEL_ARCH35_H
#define MATMUL_ALL_REDUCE_DEQUANT_PERCHANNEL_ARCH35_H
