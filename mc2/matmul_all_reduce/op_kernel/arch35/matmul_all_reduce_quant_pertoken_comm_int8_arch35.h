...
/*!
 * \file matmul_all_reduce_quant_pertoken_comm_int8_arch35.h
 * \brief
 */
#ifndef MATMUL_ALL_REDUCE_QUANT_PERTOKEN_COMM_INT8_ARCH35_H
#define MATMUL_ALL_REDUCE_QUANT_PERTOKEN_COMM_INT8_ARCH35_H
