...
/*!
 * \file matmul_all_reduce_empty_tensor_k_general_arch35.h
 * \brief
 */
#ifndef MATMUL_ALL_REDUCE_EMPTY_TENSOR_K_GENERAL_ARCH35_H
#define MATMUL_ALL_REDUCE_EMPTY_TENSOR_K_GENERAL_ARCH35_H
