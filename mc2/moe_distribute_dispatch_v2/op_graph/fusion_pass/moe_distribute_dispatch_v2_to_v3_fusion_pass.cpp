 ...
 * 属性删除 group_ep/group_tp，新增 ccl_buffer_size。与 Combine 侧 pass 共用 Mc2MoeGraphContext，
 * 同一 groupEp 得到的 context 内容一致，保证 dispatch/combine 收发同一块 HCCL window buffer。
 *
