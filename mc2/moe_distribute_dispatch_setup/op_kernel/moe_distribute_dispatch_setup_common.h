...
/*!
 * \file moe_distribute_dispatch_setup_common.h
 * \brief
 */

#ifndef MOE_DISTRIBUTE_DISPATCH_SETUP_COMMON_H
#define MOE_DISTRIBUTE_DISPATCH_SETUP_COMMON_H
...
#endif // MOE_DISTRIBUTE_DISPATCH_SETUP_COMMON_H
