...
static AlltoAllMatmulV2AclnnTestParam casesParamsV2[] = {
    ...
    // ========================bfloat16 系列（12条）========================
    // 1. Bias=BF16 (4)
    {"AclnnAlltoAllMatmulV2-bf16-bf16-biasbf16-nd-notrans-01",
     2,
     {256, 64},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_SUCCESS},
    {"AclnnAlltoAllMatmulV2-bf16-null-biasbf16-nd-notrans-02",
     2,
     {256, 64},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_SUCCESS},
    {"AclnnAlltoAllMatmulV2-bf16-bf16-biasbf16-nd-trans-03",
     2,
     {256, 64},
     {256, 128},
     {256},
     ...
     true,
     ACLNN_SUCCESS},
    {"AclnnAlltoAllMatmulV2-bf16-null-biasbf16-nd-trans-04",
     2,
     {256, 64},
     {256, 128},
     {256},
     ...
     ACLNN_SUCCESS},
    // 2. Bias=FLOAT32 (4)
    {"AclnnAlltoAllMatmulV2-bf16-bf16-biasf32-nd-notrans-05",
     2,
     {256, 64},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_SUCCESS},
    {"AclnnAlltoAllMatmulV2-bf16-null-biasf32-nd-notrans-06",
     2,
     {256, 64},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_SUCCESS},
    {"AclnnAlltoAllMatmulV2-bf16-bf16-biasf32-nd-trans-07",
     2,
     {256, 64},
     {256, 128},
     {256},
     ...
     true,
     ACLNN_SUCCESS},
    {"AclnnAlltoAllMatmulV2-bf16-null-biasf32-nd-trans-08",
     2,
     {256, 64},
     {256, 128},
     {256},
     ...
     ACLNN_SUCCESS},
    // 3. Bias=Null (4)
    {"AclnnAlltoAllMatmulV2-bf16-bf16-biasnull-nd-notrans-09",
     2,
     {256, 64},
     {128, 256},
     {},
     ...
     false,
     ACLNN_SUCCESS},
    {"AclnnAlltoAllMatmulV2-bf16-null-biasnull-nd-notrans-10",
     2,
     {256, 64},
     {128, 256},
     {},
     ...
     false,
     ACLNN_SUCCESS},
    {"AclnnAlltoAllMatmulV2-bf16-bf16-biasnull-nd-trans-11",
     2,
     {256, 64},
     {256, 128},
     {},
     ...
     true,
     ACLNN_SUCCESS},
    {"AclnnAlltoAllMatmulV2-bf16-null-biasnull-nd-trans-12",
     2,
     {256, 64},
     {256, 128},
     {},
    ...
    // ========================float16 系列（12条）========================
    // 1. Bias=FP16 (4)
    {"AclnnAlltoAllMatmulV2-fp16-fp16-biasfp16-nd-notrans-13",
     2,
     {256, 64},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_SUCCESS},
    {"AclnnAlltoAllMatmulV2-fp16-null-biasfp16-nd-notrans-14",
     2,
     {256, 64},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_SUCCESS},
    {"AclnnAlltoAllMatmulV2-fp16-fp16-biasfp16-nd-trans-15",
     2,
     {256, 64},
     {256, 128},
     {256},
     ...
     true,
     ACLNN_SUCCESS},
    {"AclnnAlltoAllMatmulV2-fp16-null-biasfp16-nd-trans-16",
     2,
     {256, 64},
     {256, 128},
     {256},
     ...
     ACLNN_SUCCESS},
    // 2. Bias=FLOAT32 (4)
    {"AclnnAlltoAllMatmulV2-fp16-fp16-biasf32-nd-notrans-17",
     2,
     {256, 64},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_SUCCESS},
    {"AclnnAlltoAllMatmulV2-fp16-null-biasf32-nd-notrans-18",
     2,
     {256, 64},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_SUCCESS},
    {"AclnnAlltoAllMatmulV2-fp16-fp16-biasf32-nd-trans-19",
     2,
     {256, 64},
     {256, 128},
     {256},
     ...
     true,
     ACLNN_SUCCESS},
    {"AclnnAlltoAllMatmulV2-fp16-null-biasf32-nd-trans-20",
     2,
     {256, 64},
     {256, 128},
     {256},
     ...
     ACLNN_SUCCESS},
    // 3. Bias=Null (4)
    {"AclnnAlltoAllMatmulV2-fp16-fp16-biasnull-nd-notrans-21",
     2,
     {256, 64},
     {128, 256},
     {},
     ...
     false,
     ACLNN_SUCCESS},
    {"AclnnAlltoAllMatmulV2-fp16-null-biasnull-nd-notrans-22",
     2,
     {256, 64},
     {128, 256},
     {},
     ...
     false,
     ACLNN_SUCCESS},
    {"AclnnAlltoAllMatmulV2-fp16-fp16-biasnull-nd-trans-23",
     2,
     {256, 64},
     {256, 128},
     {},
     ...
     true,
     ACLNN_SUCCESS},
    {"AclnnAlltoAllMatmulV2-fp16-null-biasnull-nd-trans-24",
     2,
     {256, 64},
     {256, 128},
     {},
     ...
     ACLNN_SUCCESS},
    // 空tensor场景 1条
    {"AclnnAlltoAllMatmulV2-x1_empty_tensor",
     2,
     {0, 64},
     {128, 256},
     {256},
    ...
    {"error-AclnnAlltoAllMatmulV2-x1dtype_invalid-01",
     2,
     {256, 64},
     {128, 256},
     {256},
    ...
    {"error-AclnnAlltoAllMatmulV2-x2dtype_invalid-02",
     2,
     {256, 64},
     {128, 256},
     {256},
    ...
    {"error-AclnnAlltoAllMatmulV2-biasdtype_invalid_03",
     2,
     {256, 64},
     {128, 256},
     {256},
     ...
     ACLNN_ERR_PARAM_INVALID},
    // 4. output dtype不合法
    {"error-AclnnAlltoAllMatmulV2-outdtype_mismatch-04",
     2,
     {256, 64},
     {128, 256},
     {256},
    ...
    {"error-AclnnAlltoAllMatmulV2-alltoalloutdtype_unsupport-05",
     2,
     {256, 64},
     {128, 256},
     {256},
    ...
    // 6. 空tensor (1)
    // 6.1 x1有维度为0
    {"error-AclnnAlltoAllMatmulV2-x1empty-06",
     2,
     {256, 0},
     {128, 256},
     {256},
    ...
    {"error-AclnnAlltoAllMatmulV2-x2empty-07",
     2,
     {256, 64},
     {0, 256},
     {256},
    ...
    {"error-AclnnAlltoAllMatmulV2-x2empty-08",
     2,
     {256, 64},
     {128, 0},
     {256},
     ...
     ACLNN_ERR_PARAM_INVALID},
    // 7. format为私有格式(5)
    {"error-AclnnAlltoAllMatmulV2-private_fmt1-09",
     2,
     {256, 64},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_ERR_PARAM_INVALID},
    {"error-AclnnAlltoAllMatmulV2-private_fmt2-10",
     2,
     {256, 64},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_ERR_PARAM_INVALID},
    {"error-AclnnAlltoAllMatmulV2-private_fmt3-11",
     2,
     {256, 64},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_ERR_PARAM_INVALID},
    {"error-AclnnAlltoAllMatmulV2-private_fmt4-12",
     2,
     {256, 64},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_ERR_PARAM_INVALID},
    {"error-AclnnAlltoAllMatmulV2-private_fmt5-13",
     2,
     {256, 64},
     {128, 256},
     {256},
     ...
     ACLNN_ERR_PARAM_INVALID},
    // 8. AlltoAllAxes不合法
    {"error-AclnnAlltoAllMatmulV2-invalid_axes-14",
     2,
     {256, 64},
     {128, 256},
     {256},
    ...
    // 9. group不合法
    // 9.1 group为空
    {"error-AclnnAlltoAllMatmulV2-group_empty-15",
     2,
     {256, 64},
     {128, 256},
     {256},
    ...
    {"error-AclnnAlltoAllMatmulV2-group_extralong-16",
     2,
     {256, 64},
     {128, 256},
     {256},
     ...
     ACLNN_ERR_PARAM_INVALID},
    // 10. transposeX1=true
    {"error-AclnnAlltoAllMatmulV2-transx1-17",
     2,
     {64, 256},
     {128, 256},
     {256},
    ...
    // 11. shape不合法
    // 11.1 x1维度不合法
    {"error-AclnnAlltoAllMatmulV2-invalid_x1dim-18",
     2,
     {256, 64, 32},
     {128, 256},
     {256},
     ...
     ACLNN_ERR_PARAM_INVALID},
    // 11.2 x2维度不合法
    {"error-AclnnAlltoAllMatmulV2-invalid_x2dim-19",
     2,
     {256, 64},
     {128, 256, 32},
     {256},
     ...
     ACLNN_ERR_PARAM_INVALID},
    // 11.3 output维度不合法
    {"error-AclnnAlltoAllMatmulV2-invalid_outputdim-20",
     2,
     {256, 64},
     {128, 256},
     {256},
    ...
    {"error-AclnnAlltoAllMatmulV2-invalid_alltoalloutdim-21",
     2,
     {256, 64},
     {128, 256},
     {256},
     ...
     ACLNN_ERR_PARAM_INVALID},
    // 11.5 bias维度不合法
    {"error-AclnnAlltoAllMatmulV2-invalid_biasdim-22",
     2,
     {256, 64},
     {128, 256},
     {256, 32},
     ...
     ACLNN_ERR_PARAM_INVALID},
    // 11.6 bias shape不合法
    {"error-AclnnAlltoAllMatmulV2-mismatch_biasshape-23",
     2,
     {256, 64},
     {128, 256},
     {32},
     ...
     ACLNN_ERR_PARAM_INVALID},
    // 12 comm_mode不合法
    {"error-AclnnAlltoAllMatmulV2-wrong-commMode-24",
     2,
     {256, 64},
     {128, 256},
     {256},
