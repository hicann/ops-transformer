...
/*!
 * \file mask_checker_flash_attn.h
 * \brief Checker for mask_mode, attn_mask, win_left, win_right parameters (文档约束: Mask参数组)
 */

#ifndef FLASH_ATTN_MASK_CHECKER_FLASH_ATTN_H
#define FLASH_ATTN_MASK_CHECKER_FLASH_ATTN_H
...
#endif // FLASH_ATTN_MASK_CHECKER_FLASH_ATTN_H