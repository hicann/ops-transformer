...
/*!
 * \file sinks_checker_flash_attn.h
 * \brief Checker for sinks parameter (文档参数名: sinks, 文档约束: LearnableSink参数组)
 */

#ifndef FLASH_ATTN_SINKS_CHECKER_FLASH_ATTN_H
#define FLASH_ATTN_SINKS_CHECKER_FLASH_ATTN_H
...
#endif // FLASH_ATTN_SINKS_CHECKER_FLASH_ATTN_H