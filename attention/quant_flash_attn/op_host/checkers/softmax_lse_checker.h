...
#ifndef QUANT_FLASH_ATTN_SOFTMAX_LSE_CHECKER_H
#define QUANT_FLASH_ATTN_SOFTMAX_LSE_CHECKER_H
...
class SoftmaxLSEChecker : public QfaBaseChecker {
public:
...
#endif // QUANT_FLASH_ATTN_SOFTMAX_LSE_CHECKER_H
