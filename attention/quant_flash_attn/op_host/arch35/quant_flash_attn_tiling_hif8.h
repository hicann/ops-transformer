...
/*!
 * \file quant_flash_attn_tiling_hif8.h
 * \brief QuantFlashAttn arch35 tiling implementation (A8C8_QKV_HIF8_P_PER_TENSOR_SOFTMAX_FP32)
 */
#ifndef QUANT_FLASH_ATTN_TILING_IMPL_HIF8_H_
#define QUANT_FLASH_ATTN_TILING_IMPL_HIF8_H_
...
class QuantFlashAttnTilingHif8Impl : public FiaTilingBase {
public:
    explicit QuantFlashAttnTilingHif8Impl(gert::TilingContext *context)
        : FiaTilingBase(context)
    {}
    ~QuantFlashAttnTilingHif8Impl() override = default;
...
#endif // QUANT_FLASH_ATTN_TILING_IMPL_HIF8_H_
