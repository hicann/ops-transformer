...
/*!
 * \file quant_flash_attn_block_vec_flashdecode_fullquant.h
 * \brief
 */
#ifndef QUANT_FLASH_ATTN_BLOCK_VEC_FLASHDECODE_FULLQUANT_H
#define QUANT_FLASH_ATTN_BLOCK_VEC_FLASHDECODE_FULLQUANT_H
...
template <typename INPUT_T, typename T, typename OUTPUT_T, LayOutTypeEnum layout = LayOutTypeEnum::None,
          ...
          bool hasAtten = false, bool hasDrop = false, uint8_t KvLayoutType = 0,
...
protected:
    ...
    using KvSeqParserType =
        typename std::conditional<(!isPa && (layout == LayOutTypeEnum::LAYOUT_TND ||
...
#endif // QUANT_FLASH_ATTN_BLOCK_VEC_FLASHDECODE_FULLQUANT_H