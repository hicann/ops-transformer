...
/*!
 * \file test_aclnn_mla_prolog_v3_weight_nz_fqkvq.cpp
 * \brief
 */
...
int main()
{
    ...
    ret = aclnnMlaPrologV3WeightNzGetWorkspaceSize(
        ...
        kvQuantMode, queryQuantMode, ckvkrRepoMode, quantScaleRepoMode, tileSize, qcQrScale, kcScale, query, queryRope,
        dequantScaleQNope, nullptr, nullptr, &workspaceSize, &executor);
