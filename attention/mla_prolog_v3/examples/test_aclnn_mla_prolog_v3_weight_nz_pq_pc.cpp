...
int main()
{
    ...
    ret = aclnnMlaPrologV3WeightNzGetWorkspaceSize(
        ...
        queryQuantMode, ckvkrRepoMode, quantScaleRepoMode, tileSize, qcQrScale, kcScale, query, queryRope, nullptr,
        queryNormOut, dequantScaleQNormOut, &workspaceSize, &executor);
