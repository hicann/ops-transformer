...
/*!
 * \file nsa_compress_attention_infer_kernel.h
 * \brief
 */

#ifndef NSA_COMPRESS_ATTENTION_INFER_KERNEL_H
#define NSA_COMPRESS_ATTENTION_INFER_KERNEL_H
...
#endif  // NSA_COMPRESS_ATTENTION_INFER_KERNEL_H
