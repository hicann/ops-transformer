...
/*!
 * \file dense_lightning_indexer_grad_kl_loss_vector_arch35.h
 * \brief
 */

#ifndef DENSE_LIGHTNING_INDEXER_GRAD_KL_LOSS_VECTOR_ARCH35_H
#define DENSE_LIGHTNING_INDEXER_GRAD_KL_LOSS_VECTOR_ARCH35_H
...
#include "dense_lightning_indexer_grad_kl_loss_tiling_data_arch35.h"
#include "vf/dense_lightning_indexer_grad_kl_loss_cast_vf.h"
#include "vf/dense_lightning_indexer_grad_kl_loss_grad_vf.h"
#include "vf/dense_lightning_indexer_grad_kl_loss_loss_vf.h"
#include "vf/dense_lightning_indexer_grad_kl_loss_p_vf.h"
...
class DenseLightningIndexerGradKLLossVector {
public:
    ...
    __aicore__ inline void DeterAddKIndexGrad();
    ...
    __aicore__ inline void SaveDeterLoss();
...
template <typename DLIT>
__aicore__ inline void DenseLightningIndexerGradKLLossVector<DLIT>::InitParams(
...
template <typename DLIT>
__aicore__ inline void DenseLightningIndexerGradKLLossVector<DLIT>::InitBuffers(TPipe *pipe)
{
...
template <typename DLIT>
__aicore__ inline void DenseLightningIndexerGradKLLossVector<DLIT>::AllocEventID()
{
...
template <typename DLIT>
__aicore__ inline void DenseLightningIndexerGradKLLossVector<DLIT>::FreeEventID()
{
    ...
    DLIGradKLLossRunInfo &runInfo)
{
    ...
    if constexpr (!IsSameType<W_T, float>::value) {
        ...
        DenseDliGradKLLossArch35::CastFp32ToOut<W_T>(ubOutPing_, ubInPing_, dWeightCount);
    ...
    DLIGradKLLossRunInfo &runInfo)
{
    ...
    for (uint32_t n1IndexId = 0; n1IndexId < constInfo.n1IndexSize; n1IndexId++) {
        ...
        DenseDliGradKLLossArch35::CastFp32ToOut<OUT_T>(dQueryIndexUbOut, dQueryIndexUbIn, dqCount);
...
template <typename DLIT>
__aicore__ inline void DenseLightningIndexerGradKLLossVector<DLIT>::DeterAddKIndexGrad()
{
    for (int aicIdx = 0; aicIdx < constInfo.aicNum; aicIdx++) {
        ...
        for (int64_t loopIdx = 0; loopIdx < loopTimes; loopIdx++) {
            ...
            int64_t lineOffset = loopIdx * linesOneLoop;
            int64_t processLines = Min(linesOneLoop, perCoreS2Line - lineOffset);
    ...
    const DLIGradKLLossRunInfo &info)
{
    ...
    deterCoreInfoUb_.SetValue(3, info.accumS1Idx);
    deterCoreInfoUb_.SetValue(4, static_cast<int64_t>(info.curS1Size));
    deterCoreInfoUb_.SetValue(5, static_cast<int64_t>(info.taskId));
...
template <typename DLIT>
__aicore__ inline void DenseLightningIndexerGradKLLossVector<DLIT>::SaveDeterRunInfoInvalid()
{
    event_t mte3ToScalar = static_cast<event_t>(GetTPipePtr()->FetchEventID(HardEvent::MTE3_S));
    AscendC::SetFlag<HardEvent::MTE3_S>(mte3ToScalar);
    AscendC::WaitFlag<HardEvent::MTE3_S>(mte3ToScalar);
    ...
    deterCoreInfoUb_.SetValue(3, DETER_INVALID_RUNINFO_VALUE);
    deterCoreInfoUb_.SetValue(4, DETER_INVALID_RUNINFO_VALUE);
    deterCoreInfoUb_.SetValue(5, DETER_INVALID_RUNINFO_VALUE);
...
#endif // DENSE_LIGHTNING_INDEXER_GRAD_KL_LOSS_VECTOR_ARCH35_H
