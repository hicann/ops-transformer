...
/*!
 * \file dense_lightning_indexer_grad_kl_loss_vector2_arch35.h
 * \brief
 */

#ifndef DENSE_LIGHTNING_INDEXER_GRAD_KL_LOSS_VECTOR2_ARCH35_H
#define DENSE_LIGHTNING_INDEXER_GRAD_KL_LOSS_VECTOR2_ARCH35_H
...
class DenseLightningIndexerGradKLLossVector2 {
public:
...
template <typename DLIT>
__aicore__ inline void DenseLightningIndexerGradKLLossVector2<DLIT>::InitParams(
...
template <typename DLIT>
__aicore__ inline void DenseLightningIndexerGradKLLossVector2<DLIT>::InitBuffers(TPipe *pipe)
{
    pipe->Reset();
...
template <typename DLIT>
__aicore__ inline void DenseLightningIndexerGradKLLossVector2<DLIT>::ProcessVectorDk()
{
    ...
    for (int64_t loopIdx = 0; loopIdx < loopTimes; loopIdx++) {
        ...
        DenseDliGradKLLossArch35::CastFp32ToOut<OUT_T>(dKeyIndexUbOut, dKeyIndexUbIn, processNumPad);
...
template <typename DLIT>
__aicore__ inline void DenseLightningIndexerGradKLLossVector2<DLIT>::DeterSumLoss()
{
    if (constInfo.aivIdx == 0) {
        ...
        GetTPipePtr()->ReleaseEventID<HardEvent::MTE3_S>(mte3ToScalar);
    }
}

#endif // DENSE_LIGHTNING_INDEXER_GRAD_KL_LOSS_VECTOR2_ARCH35_H
