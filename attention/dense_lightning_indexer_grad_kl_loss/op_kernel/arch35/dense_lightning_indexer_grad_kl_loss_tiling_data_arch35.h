...
/*!
 * \file dense_lightning_indexer_grad_kl_loss_tiling_data_arch35.h
 * \brief tiling data struct
 */

#ifndef __DENSE_LIGHTNING_INDEXER_GRAD_KL_LOSS_TILLING_DATA_H___ARCH35
#define __DENSE_LIGHTNING_INDEXER_GRAD_KL_LOSS_TILLING_DATA_H___ARCH35
