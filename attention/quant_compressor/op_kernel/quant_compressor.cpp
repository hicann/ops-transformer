...
__global__ __aicore__ void quant_compressor(__gm__ uint8_t *x, __gm__ uint8_t *wKv, __gm__ uint8_t *wGate,
                                            ...
                                            __gm__ uint8_t *stateCacheOut, __gm__ uint8_t *workspace,
