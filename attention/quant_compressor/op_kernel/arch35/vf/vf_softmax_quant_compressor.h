...
/*!
 * \file vf_softmax_quant_compressor.h
 * \brief
 */

#ifndef VF_SOFTMAX_QUANT_COMPRESSOR_H
#define VF_SOFTMAX_QUANT_COMPRESSOR_H
                                         ...
                                         const uint32_t ReduceSize, const uint32_t vScRealSize, const T minValue)
{
    ...
    __ubuf__ float *srcUb00 = outputAddr;
    __ubuf__ float *srcUb01 = outputAddr + RowSize * (ReduceSize / BASE_REDUCE_SIZE);
    __ubuf__ float *srcUb10 = srcUb00 + ReduceSize * RowSize;
    __ubuf__ float *srcUb11 = srcUb00 + ReduceSize * RowSize + RowSize * (ReduceSize / BASE_REDUCE_SIZE);
    __ubuf__ float *srcUb20 = srcUb00 + ReduceSize * RowSize * 2;
    __ubuf__ float *srcUb21 = srcUb00 + ReduceSize * RowSize * 2 + RowSize * (ReduceSize / BASE_REDUCE_SIZE);
    __ubuf__ float *srcUb30 = srcUb00 + ReduceSize * RowSize * 3;
    __ubuf__ float *srcUb31 = srcUb00 + ReduceSize * RowSize * 3 + RowSize * (ReduceSize / BASE_REDUCE_SIZE);
...
#endif // VF_SOFTMAX_QUANT_COMPRESSOR_H
