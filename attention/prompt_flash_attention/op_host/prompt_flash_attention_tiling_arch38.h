...
public:
    ...
    explicit PromptFlashAttentionTilingArch38(gert::TilingContext *context)
    ...
    ge::graphStatus PromptFlashAttentionSetTilingData(gert::TilingContext *context,
                                                      PromptFlashAttentionTilingData &tilingData);
    ge::graphStatus DoSubOpTiling(PromptFlashAttentionTilingData &tilingData,
...
protected:
    ...
    bool SetAndCheckHeadNumRatio(ContextParamsForPFATiling &contextKeyParams,
                                 PromptFlashAttentionTilingData &tilingData);
    bool CheckInputDimAndHeadNum(ContextParamsForPFATiling &contextKeyParams, const uint32_t nQAttr,
    ...
    bool CheckPostQuantShape(const ContextParamsForPFATiling &contextKeyParams,
                             ...
                             int64_t quantScale2ShapeSize, const PFAShapeInfo &queryShapeInfo,
    ...
    bool GetAndCheckPrefixShape(ContextParamsForPFATiling &contextKeyParams, const PFAShapeInfo &queryShapeInfo,
                                PFAShapeInfo &prefixShapeInfo, PromptFlashAttentionTilingData &tilingData) const;
    bool CheckKeyValuePrefixConsistency(ContextParamsForPFATiling &contextKeyParams,
    ...
    bool CheckPAKeyValueShape(ContextParamsForPFATiling &contextKeyParams, int64_t &keyDim1,
                              const PFAShapeInfo &queryShapeInfo, const gert::StorageShape *keyShape,
    ...
    bool CheckPACacheShape(ContextParamsForPFATiling &contextKeyParams, const size_t keyDim,
                           const PFAShapeInfo &shapeInfo, const gert::StorageShape *shape, const int32_t *blockSize,
                           int64_t blockNumValid, int32_t headNumRatio, const std::string &sName);
    bool CheckBlockTableShape(ContextParamsForPFATiling &contextKeyParams, PFAShapeInfo &queryShapeInfo,
                              ...
                              const gert::StorageShape *blockTableShape, PromptFlashAttentionTilingData &tilingData);
    ...
    void SetSparseModeData(ContextParamsForPFATiling &contextKeyParams, const gert::StorageShape *attenMaskShape,
                           PromptFlashAttentionTilingData &tilingData, const int32_t *sparseMode,
                           const int64_t *preTokens, const int64_t *nextTokens);
    bool CheckMaskShapeCrossSparse(ContextParamsForPFATiling &contextKeyParams, const int32_t *sparseMode, uint64_t sQ,
    ...
    bool CheckIO(ContextParamsForPFATiling &contextKeyParams, PFAShapeInfo &queryShapeInfo,
                 PFAShapeInfo &valueShapeInfo);
    bool CheckKV(ContextParamsForPFATiling &contextKeyParams, PFAShapeInfo &keyShapeInfo,
    ...
    bool CheckPrefix(ContextParamsForPFATiling &contextKeyParams, PFAShapeInfo &queryShapeInfo,
                     PFAShapeInfo &keyShapeInfo, PromptFlashAttentionTilingData &tilingData);
    ...
    bool CheckPseShiftTypeAndShape(ContextParamsForPFATiling &contextKeyParams, uint32_t b, uint32_t n, uint32_t s1,
                                   uint32_t s2);
    ...
    void SetTilingDataAttribute(ContextParamsForPFATiling &contextKeyParams,
                                PromptFlashAttentionTilingData &tilingData);
    void GetEnableDN(PromptFlashAttentionTilingData &tilingData, PFAShapeInfo &queryShapeInfo,
                     const PFAShapeInfo &valueShapeInfo, std::vector<int64_t> &actualSeqLengths,
    ...
    void SetTilingData(ContextParamsForPFATiling &contextKeyParams, PFAShapeInfo &queryShapeInfo,
                       PFAShapeInfo &queryRopeShapeInfo, PFAShapeInfo &valueShapeInfo,
                       PromptFlashAttentionTilingData &tilingData);
    ...
    void ComputeSplitNBSeq(PromptFlashAttentionTilingData &tilingData, uint32_t batchSize,
    ...
    void PromptFlashAttentionSplitNBSeq(PromptFlashAttentionTilingData &tilingData,
    ...
    bool PromptFlashAttentionCheckBmm1(PromptFlashAttentionTilingData &tilingData, TCubeTiling &bmm1TilingData,
                                       ...
                                       uint32_t sInnerFactor, bool autoBaseMNK = false);
    bool PromptFlashAttentionCheckBmm2(PromptFlashAttentionTilingData &tilingData, TCubeTiling &bmm2TilingData,
                                       int64_t l1SizeRemain, int64_t l0CSize, uint32_t sOuterFactor,
                                       uint32_t sInnerFactor, uint32_t dSplitFactor, bool autoBaseMNK = false);
    bool PromptFlashAttentionComputeCVDiffParams(PromptFlashAttentionTilingData &tilingData, int64_t l1Size,
    ...
    void PromptFlashAttentionInitSoftmaxLseOutputSplit(int64_t totalSize,
