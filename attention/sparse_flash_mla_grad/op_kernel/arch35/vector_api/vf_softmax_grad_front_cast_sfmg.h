...
/*!
 * \file vf_softmax_grad_front_cast_sfmg.h
 */
#ifndef MY_SOFTMAX_GRAD_CAST_INTERFACE_H__SFMG
#define MY_SOFTMAX_GRAD_CAST_INTERFACE_H__SFMG
#include "kernel_tensor.h"
#include "vf_softmax_grad_front_cast_aligned512_f16_sfmg.h"
