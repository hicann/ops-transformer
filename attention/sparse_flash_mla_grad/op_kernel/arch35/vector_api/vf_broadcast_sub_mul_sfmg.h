...
/*!
 * \file vf_broadcast_sub_mul_sfmg.h
 */
#ifndef MY_BROADCAST_SUB_MUL_INTERFACE_SFMG_H
#define MY_BROADCAST_SUB_MUL_INTERFACE_SFMG_H
...
#endif // MY_BROADCAST_SUB_MUL_INTERFACE_SFMG_H
