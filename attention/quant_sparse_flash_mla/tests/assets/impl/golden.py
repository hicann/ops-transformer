...
def load_pytest_golden():
    ...
    try:
        ...
        raise RuntimeError(
            "Failed to load QuantSparseFlashMla pytest Golden module; "
...
def cpu_quant_sparse_flash_mla(
    q,
    *,
...
def cpu_aclnn_quant_sparse_flash_mla(
    q,
    ori_kv,
    cmp_kv,
    q_descale,
    ...
    **kwargs,
    ...
    return cpu_quant_sparse_flash_mla(
        q,
