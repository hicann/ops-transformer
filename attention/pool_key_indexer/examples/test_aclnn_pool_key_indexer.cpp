...
int InitializeTensors(TensorResources &resources)
{
    ...
    ret = CreateAclTensor(poolKeyHostData, poolKeyShape, &resources.poolKeyDeviceAddr, aclDataType::ACL_FLOAT16,
                          &resources.poolKeyTensor);
    if (!CHECK_RET(ret == ACL_SUCCESS)) {
        return ret;
    }
...
int ExecutePoolKeyIndexer(TensorResources &resources, aclrtStream stream, void **workspaceAddr, uint64_t *workspaceSize)
{
    int64_t topk = 2048;
    int64_t poolSize = 16;
    int64_t maskMode = 3;
    ...
    int ret = aclnnPoolKeyIndexerGetWorkspaceSize(
        resources.queryTensor, resources.poolKeyTensor, resources.weightsTensor, poolTailK, nullptr, nullptr, nullptr,
        nullptr, nullptr, topk, poolSize, layoutQuery, layoutKey, maskMode, quantMode, returnValue, keyStride0,
        kDescaleStride0, resources.sparseIndicesTensor, resources.sparseValuesTensor, workspaceSize, &executor);
