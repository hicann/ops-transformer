...
/*!
 * \file ring_attention_update_kernel.h
 * \brief
 */
#ifndef _RING_ATTENTION_UPDATE_H__KERNEL
#define _RING_ATTENTION_UPDATE_H__KERNEL
...
#endif // _RING_ATTENTION_UPDATE_H__KERNEL