...
protected:
    ...
    {
        std::cout << "KvQuantSparseFlashAttentionV2TilingArch35 SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "KvQuantSparseFlashAttentionV2TilingArch35 TearDown" << std::endl;
    }
};

// 0
TEST_F(KvQuantSparseFlashAttentionV2TilingArch35, KvQuantSparseFlashAttentionV2_950_tiling_0)
{
    struct KvQuantSparseFlashAttentionV2CompileInfo {
    } compileInfo;
...
// 1
TEST_F(KvQuantSparseFlashAttentionV2TilingArch35, KvQuantSparseFlashAttentionV2_950_tiling_1)
{
    struct KvQuantSparseFlashAttentionV2CompileInfo {
    } compileInfo;
...
TEST_F(KvQuantSparseFlashAttentionV2TilingArch35, KvQuantSparseFlashAttentionV2_950_tiling_2)
{
    struct KvQuantSparseFlashAttentionV2CompileInfo {
    } compileInfo;
    int32_t actualSeqQuery[] = {32, 64};
