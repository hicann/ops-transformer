...
ASCENDC_TPL_ARGS_DECL(
    FlashAttentionScore, // 算子唯一标识，可以opType保持一致
                         // bit:3-0 1: 空tensor场景
...
// FP16    96 = 2*3*2*2*2*2 S1S2模板
    ...
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_UINT_SEL(KernelTypeKey, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(UB0, ASCENDC_TPL_UI_LIST, 3),
        ASCENDC_TPL_UINT_SEL(UB1, ASCENDC_TPL_UI_LIST, 4), ASCENDC_TPL_UINT_SEL(Block, ASCENDC_TPL_UI_LIST, 9),
        ...
        ASCENDC_TPL_UINT_SEL(Bmm2Source, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(Sparse, ASCENDC_TPL_UI_LIST, 2),
    ...
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_UINT_SEL(KernelTypeKey, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(UB0, ASCENDC_TPL_UI_LIST, 3),
        ASCENDC_TPL_UINT_SEL(UB1, ASCENDC_TPL_UI_LIST, 5), ASCENDC_TPL_UINT_SEL(Block, ASCENDC_TPL_UI_LIST, 9),
        ASCENDC_TPL_UINT_SEL(ImplMode, ASCENDC_TPL_UI_LIST, 0, 2),
        ASCENDC_TPL_UINT_SEL(DataType, ASCENDC_TPL_UI_LIST, 3),
        ASCENDC_TPL_UINT_SEL(Layout, ASCENDC_TPL_UI_LIST, 1, 2, 3),
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(Layout, ASCENDC_TPL_UI_LIST, 1, 2, 3),
        ASCENDC_TPL_UINT_SEL(Bmm1Format, ASCENDC_TPL_UI_LIST, 0, 1),
        ASCENDC_TPL_UINT_SEL(Bmm2Source, ASCENDC_TPL_UI_LIST, 1), ASCENDC_TPL_UINT_SEL(Sparse, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(BigDoubleBuffer, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(HasDropOut, ASCENDC_TPL_UI_LIST, 0, 1),
        ASCENDC_TPL_UINT_SEL(HasAttenMask, ASCENDC_TPL_UI_LIST, 0, 1),
        ASCENDC_TPL_UINT_SEL(HasPse, ASCENDC_TPL_UI_LIST, 0, 1),
    ...
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_UINT_SEL(KernelTypeKey, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(UB0, ASCENDC_TPL_UI_LIST, 9),
        ASCENDC_TPL_UINT_SEL(UB1, ASCENDC_TPL_UI_LIST, 9), ASCENDC_TPL_UINT_SEL(Block, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(ImplMode, ASCENDC_TPL_UI_LIST, 0, 2),
        ASCENDC_TPL_UINT_SEL(DataType, ASCENDC_TPL_UI_LIST, 3),
        ASCENDC_TPL_UINT_SEL(Layout, ASCENDC_TPL_UI_LIST, 1, 2, 3),
        ASCENDC_TPL_UINT_SEL(Bmm1Format, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(Bmm2Source, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(Sparse, ASCENDC_TPL_UI_LIST, 1),
        ASCENDC_TPL_UINT_SEL(BigDoubleBuffer, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(HasDropOut, ASCENDC_TPL_UI_LIST, 0, 1),
        ASCENDC_TPL_UINT_SEL(HasAttenMask, ASCENDC_TPL_UI_LIST, 0, 1),
        ASCENDC_TPL_UINT_SEL(HasPse, ASCENDC_TPL_UI_LIST, 0, 1),
    ...
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_UINT_SEL(KernelTypeKey, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(UB0, ASCENDC_TPL_UI_LIST, 3),
        ASCENDC_TPL_UINT_SEL(UB1, ASCENDC_TPL_UI_LIST, 9), ASCENDC_TPL_UINT_SEL(Block, ASCENDC_TPL_UI_LIST, 9),
        ASCENDC_TPL_UINT_SEL(ImplMode, ASCENDC_TPL_UI_LIST, 0, 2),
        ASCENDC_TPL_UINT_SEL(DataType, ASCENDC_TPL_UI_LIST, 3),
        ASCENDC_TPL_UINT_SEL(Layout, ASCENDC_TPL_UI_LIST, 1, 2, 3),
        ASCENDC_TPL_UINT_SEL(Bmm1Format, ASCENDC_TPL_UI_LIST, 1),
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(UB1, ASCENDC_TPL_UI_LIST, 9), ASCENDC_TPL_UINT_SEL(Block, ASCENDC_TPL_UI_LIST, 9),
        ASCENDC_TPL_UINT_SEL(ImplMode, ASCENDC_TPL_UI_LIST, 0, 2),
        ASCENDC_TPL_UINT_SEL(DataType, ASCENDC_TPL_UI_LIST, 3), ASCENDC_TPL_UINT_SEL(Layout, ASCENDC_TPL_UI_LIST, 3),
        ASCENDC_TPL_UINT_SEL(Bmm1Format, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(Bmm2Source, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(Sparse, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(BigDoubleBuffer, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(HasDropOut, ASCENDC_TPL_UI_LIST, 0, 1),
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(UB1, ASCENDC_TPL_UI_LIST, 4), ASCENDC_TPL_UINT_SEL(Block, ASCENDC_TPL_UI_LIST, 9),
        ASCENDC_TPL_UINT_SEL(ImplMode, ASCENDC_TPL_UI_LIST, 0, 2),
        ASCENDC_TPL_UINT_SEL(DataType, ASCENDC_TPL_UI_LIST, 3), ASCENDC_TPL_UINT_SEL(Layout, ASCENDC_TPL_UI_LIST, 4),
        ASCENDC_TPL_UINT_SEL(Bmm1Format, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(Bmm2Source, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(Sparse, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(BigDoubleBuffer, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(HasDropOut, ASCENDC_TPL_UI_LIST, 0, 1),
    ...
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_UINT_SEL(KernelTypeKey, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(UB0, ASCENDC_TPL_UI_LIST, 3),
        ASCENDC_TPL_UINT_SEL(UB1, ASCENDC_TPL_UI_LIST, 4), ASCENDC_TPL_UINT_SEL(Block, ASCENDC_TPL_UI_LIST, 9),
        ASCENDC_TPL_UINT_SEL(ImplMode, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(DataType, ASCENDC_TPL_UI_LIST, 3),
        ASCENDC_TPL_UINT_SEL(Layout, ASCENDC_TPL_UI_LIST, 4), ASCENDC_TPL_UINT_SEL(Bmm1Format, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(Bmm2Source, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(Sparse, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(BigDoubleBuffer, ASCENDC_TPL_UI_LIST, 2),
...
// BF16    96 = 2*3*2*2*2*2 S1S2模板
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(UB1, ASCENDC_TPL_UI_LIST, 5), ASCENDC_TPL_UINT_SEL(Block, ASCENDC_TPL_UI_LIST, 9),
        ASCENDC_TPL_UINT_SEL(ImplMode, ASCENDC_TPL_UI_LIST, 0, 2),
        ASCENDC_TPL_UINT_SEL(DataType, ASCENDC_TPL_UI_LIST, 2), ASCENDC_TPL_UINT_SEL(Layout, ASCENDC_TPL_UI_LIST, 1),
        ASCENDC_TPL_UINT_SEL(Bmm1Format, ASCENDC_TPL_UI_LIST, 0, 1),
        ASCENDC_TPL_UINT_SEL(Bmm2Source, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(Sparse, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(BigDoubleBuffer, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(HasDropOut, ASCENDC_TPL_UI_LIST, 0),
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(UB1, ASCENDC_TPL_UI_LIST, 5), ASCENDC_TPL_UINT_SEL(Block, ASCENDC_TPL_UI_LIST, 9),
        ASCENDC_TPL_UINT_SEL(ImplMode, ASCENDC_TPL_UI_LIST, 0, 2),
        ASCENDC_TPL_UINT_SEL(DataType, ASCENDC_TPL_UI_LIST, 2), ASCENDC_TPL_UINT_SEL(Layout, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(Bmm1Format, ASCENDC_TPL_UI_LIST, 0, 1),
        ASCENDC_TPL_UINT_SEL(Bmm2Source, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(Sparse, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(BigDoubleBuffer, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(HasDropOut, ASCENDC_TPL_UI_LIST, 0),
    ...
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_UINT_SEL(KernelTypeKey, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(UB0, ASCENDC_TPL_UI_LIST, 9),
        ASCENDC_TPL_UINT_SEL(UB1, ASCENDC_TPL_UI_LIST, 9), ASCENDC_TPL_UINT_SEL(Block, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(ImplMode, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(DataType, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(Layout, ASCENDC_TPL_UI_LIST, 1), ASCENDC_TPL_UINT_SEL(Bmm1Format, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(Bmm2Source, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(Sparse, ASCENDC_TPL_UI_LIST, 1),
        ASCENDC_TPL_UINT_SEL(BigDoubleBuffer, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(HasDropOut, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(HasAttenMask, ASCENDC_TPL_UI_LIST, 0),
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(UB1, ASCENDC_TPL_UI_LIST, 9), ASCENDC_TPL_UINT_SEL(Block, ASCENDC_TPL_UI_LIST, 9),
        ASCENDC_TPL_UINT_SEL(ImplMode, ASCENDC_TPL_UI_LIST, 0, 2),
        ASCENDC_TPL_UINT_SEL(DataType, ASCENDC_TPL_UI_LIST, 2), ASCENDC_TPL_UINT_SEL(Layout, ASCENDC_TPL_UI_LIST, 3),
        ASCENDC_TPL_UINT_SEL(Bmm1Format, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(Bmm2Source, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(Sparse, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(BigDoubleBuffer, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(HasDropOut, ASCENDC_TPL_UI_LIST, 0, 1),
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(UB1, ASCENDC_TPL_UI_LIST, 4), ASCENDC_TPL_UINT_SEL(Block, ASCENDC_TPL_UI_LIST, 9),
        ASCENDC_TPL_UINT_SEL(ImplMode, ASCENDC_TPL_UI_LIST, 0, 2),
        ASCENDC_TPL_UINT_SEL(DataType, ASCENDC_TPL_UI_LIST, 2), ASCENDC_TPL_UINT_SEL(Layout, ASCENDC_TPL_UI_LIST, 4),
        ASCENDC_TPL_UINT_SEL(Bmm1Format, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(Bmm2Source, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(Sparse, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(BigDoubleBuffer, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(HasDropOut, ASCENDC_TPL_UI_LIST, 0, 1),
...
// FP32    48 = 2*3*2*2*2 S1S2模板
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(UB1, ASCENDC_TPL_UI_LIST, 4), ASCENDC_TPL_UINT_SEL(Block, ASCENDC_TPL_UI_LIST, 9),
        ASCENDC_TPL_UINT_SEL(ImplMode, ASCENDC_TPL_UI_LIST, 0, 2),
        ASCENDC_TPL_UINT_SEL(DataType, ASCENDC_TPL_UI_LIST, 1), ASCENDC_TPL_UINT_SEL(Layout, ASCENDC_TPL_UI_LIST, 4),
        ASCENDC_TPL_UINT_SEL(Bmm1Format, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(Bmm2Source, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(Sparse, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(BigDoubleBuffer, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(HasDropOut, ASCENDC_TPL_UI_LIST, 0, 1),
    ...
    // 空tensor
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_UINT_SEL(KernelTypeKey, ASCENDC_TPL_UI_LIST, 1), ASCENDC_TPL_UINT_SEL(UB0, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(UB1, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(Block, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(ImplMode, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(DataType, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(Layout, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(Bmm1Format, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(Bmm2Source, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(Sparse, ASCENDC_TPL_UI_LIST, 0),
