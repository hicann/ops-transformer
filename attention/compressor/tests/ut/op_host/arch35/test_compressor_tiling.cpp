...
protected:
    static void SetUpTestCase() { std::cout << "CompressorTilingArch35 SetUp" << std::endl; }
    static void TearDownTestCase() { std::cout << "CompressorTilingArch35 TearDown" << std::endl; }
};
