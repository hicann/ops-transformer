...
/*!
 * \file vf_broadcast_sub_mul_sfag.h
 */
#ifndef MY_BROADCAST_SUB_MUL_INTERFACE_SFAG_H
#define MY_BROADCAST_SUB_MUL_INTERFACE_SFAG_H
...
#endif // MY_BROADCAST_SUB_MUL_INTERFACE_SFAG_H
