...
/*!
 * \file infer_flash_attention_comm_arch38.h
 * \brief
 */
#ifndef INFER_FLASH_ATTENTION_COMM_ARCH38_H
#define INFER_FLASH_ATTENTION_COMM_ARCH38_H
#include <type_traits>
...
#endif // INFER_FLASH_ATTENTION_COMM_ARCH38_H
