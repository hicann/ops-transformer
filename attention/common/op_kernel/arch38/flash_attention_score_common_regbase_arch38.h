 ...
 * \brief
 */
#ifndef FLASH_ATTENTION_SCORE_COMMON_REGBASE_ARCH38_H
#define FLASH_ATTENTION_SCORE_COMMON_REGBASE_ARCH38_H
...
#endif // FLASH_ATTENTION_SCORE_COMMON_REGBASE_ARCH38_H
