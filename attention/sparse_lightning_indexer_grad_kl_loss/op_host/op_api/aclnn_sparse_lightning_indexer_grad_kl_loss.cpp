    ...
    uint64_t *workspaceSize, aclOpExecutor **executor)
{
    return aclnnInnerSparseLightningIndexerGradKLLossGetWorkspaceSize(
        ...
        keyRopeOptional, actualSeqLengthsQueryOptional, actualSeqLengthsKeyOptional, nullptr, scaleValue, layout,
        sparseMode, preTokens, nextTokens, deterministic, dQueryIndex, dKeyIndex, dWeight, loss, workspaceSize,
        executor);
}

aclnnStatus aclnnSparseLightningIndexerGradKLLoss(void *workspace, uint64_t workspaceSize, aclOpExecutor *executor,
