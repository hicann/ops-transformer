                ...
                for (uint32_t j = 0; j < colLoop; j++) {
                    ...
                    for (uint32_t k = 0; k < actDealtRowCurLoop; k++) {
                        ...
                        AscendC::GatherMask(sparseIdxUb[IdxPingPongFlag][k * PRE_COL_TILE], maskIdxUb,
                                            ...
                                            {1, 1, 0, 0}, sparseCountPerRowCurColLoop[k]);
                        ...
                        AscendC::DataCopyPad(
                            gSparseIdx[globalRowOffset * yBlockNumAligned + k * yBlockNumAligned +
                                       sparseCountPerRow[k]],
                            sparseIdxUb[IdxPingPongFlag][k * PRE_COL_TILE],
                            AscendC::DataCopyExtParams(1, sparseCountPerRowCurColLoop[k] * sizeof(ElementSparseIdx), 0,
                                                       0, 0));
