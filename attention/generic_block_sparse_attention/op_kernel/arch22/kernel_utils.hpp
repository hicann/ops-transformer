...
struct GbsaKernelParamsArch22 {
    ...
    __aicore__ inline GbsaKernelParamsArch22() {}
    __aicore__ inline GbsaKernelParamsArch22(GM_ADDR q_, GM_ADDR k_, GM_ADDR v_, GM_ADDR sparseBlockIdx_,
...
#endif // GBSA_ARCH22_KERNEL_UTILS
