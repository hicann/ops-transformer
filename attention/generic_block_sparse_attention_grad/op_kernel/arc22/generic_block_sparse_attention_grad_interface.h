...
#ifndef GENERIC_BLOCK_SPARSE_ATTENTION_GRAD_INTERFACE_H
#define GENERIC_BLOCK_SPARSE_ATTENTION_GRAD_INTERFACE_H

#include "kernel_operator.h"
#include "generic_block_sparse_attention_grad_k_out_kernel.h"

using namespace NpuArch;

namespace GBSAG {
template <typename InputDtype = half,
          uint32_t InputLayout = 0> // 0=TND, 1=BNSD, 2=BSND
__aicore__ inline void GenericBlockSparseAttentionGradInfer(
    GM_ADDR q, GM_ADDR k, GM_ADDR v, GM_ADDR dout, GM_ADDR out, GM_ADDR softmaxLse, GM_ADDR rsvdBlockIdx,
    GM_ADDR rsvdBlockCount, GM_ADDR metadata, GM_ADDR attentionMask, GM_ADDR cuSeqLengthsQ, GM_ADDR cuSeqLengthsKv,
    GM_ADDR sequsedQ, GM_ADDR sequsedKv, GM_ADDR dq, GM_ADDR dk, GM_ADDR dv, GM_ADDR workspace, GM_ADDR tiling)
{
    (void)cuSeqLengthsQ;
    (void)cuSeqLengthsKv;
    ...
    using DispatchPolicyCube1 = Gemm::MmadAtlasA2GBSAG2;
    ...
    using DispatchPolicyCube2 = Gemm::MmadAtlasA2GBSAG2;
    ...
    using DispatchPolicyCube3 = Gemm::MmadAtlasA2GBSAG2;
    using L1TileShape3 = GemmShape<128, 128, 128>;
    using L0TileShape3 = GemmShape<128, 128, 128>;
    using BlockMmadCube3 =
        Gemm::Block::BlockMmad<DispatchPolicyCube3, L1TileShape3, L0TileShape3, A3Type, B3Type, C3Type>;
    ...
    using GBSAGKernel =
        GenericBlockSparseAttentionGradKOutKernel<BlockMmadCube1, BlockMmadCube2, BlockMmadCube3, EpilogueFAGPre,
                                                  EpilogueFAGSfmg, EpilogueFAGOp, EpilogueFAGPost, InputLayout>;
    typename GBSAGKernel::Params params{dout,
                                        q,
                                        k,
                                        v,
                                        out,
...
#endif // GENERIC_BLOCK_SPARSE_ATTENTION_GRAD_INTERFACE_H
