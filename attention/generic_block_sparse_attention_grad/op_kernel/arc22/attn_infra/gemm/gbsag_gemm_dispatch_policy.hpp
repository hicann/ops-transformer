...
#ifndef GBSAG_DISPATCH_POLICY_HPP
#define GBSAG_DISPATCH_POLICY_HPP
...
struct MmadAtlasA2GBSAG1 : public MmadAtlasA2 {
    static constexpr uint32_t STAGES = 2;
};

struct MmadAtlasA2GBSAG2 : public MmadAtlasA2 {
    static constexpr uint32_t STAGES = 2;
};

struct MmadAtlasA2GBSAG3 : public MmadAtlasA2 {
    static constexpr uint32_t STAGES = 2;
};
