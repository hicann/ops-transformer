...
/* !
 * \file dense_lightning_indexer_kl_loss_grad_tiling_regbase.h
 * \brief
 */
...
namespace optiling {
// ------------------公共定义--------------------------
const uint32_t DLIKG_MAX_AIC_CORE_NUM_REGBASE = 36;
constexpr uint32_t MAX_CORE_NUM_REGBASE = 36; // 目前使用AIC核的最大值为36

// -----------算子TilingData定义---------------
class DLIKGradBaseParamsRegbase {
public:
    // 基础输入参数
    int32_t bSize;
    int32_t t1Size;
    ...
    uint32_t get_cmpRatio() const { return cmpRatio; }
    void set_cmpRatio(uint32_t cmpRatioParam) { this->cmpRatio = cmpRatioParam; }
...
class DLIKGradMultiCoreParamsRegbase {
public:
    uint32_t coreNum;
    uint32_t rsvd;
    ...
    int64_t get_weightPreBlockFactor() const { return weightPreBlockFactor; }
    int64_t get_weightPreBlockTotal() const { return weightPreBlockTotal; }
    int64_t get_weightPreBlockTail() const { return weightPreBlockTail; }
    int64_t get_softmaxOutPreBlockFactor() const { return softmaxOutPreBlockFactor; }
    int64_t get_softmaxOutPreBlockTotal() const { return softmaxOutPreBlockTotal; }
    int64_t get_softmaxOutPreBlockTail() const { return softmaxOutPreBlockTail; }
    int64_t get_kPostBlockFactor() const { return kPostBlockFactor; }
    int64_t get_kPostBlockTotal() const { return kPostBlockTotal; }
    int64_t get_kPostBlockTail() const { return kPostBlockTail; }

    void set_postUbBaseSize(int64_t value) { this->postUbBaseSize = value; }
    void set_qPreBlockFactor(int64_t value) { this->qPreBlockFactor = value; }
    void set_qPreBlockTotal(int64_t value) { this->qPreBlockTotal = value; }
    void set_qPreBlockTail(int64_t value) { this->qPreBlockTail = value; }
    void set_kPreBlockFactor(int64_t value) { this->kPreBlockFactor = value; }
    void set_kPreBlockTotal(int64_t value) { this->kPreBlockTotal = value; }
    void set_kPreBlockTail(int64_t value) { this->kPreBlockTail = value; }
    void set_weightPreBlockFactor(int64_t value) { this->weightPreBlockFactor = value; }
    void set_weightPreBlockTotal(int64_t value) { this->weightPreBlockTotal = value; }
    void set_weightPreBlockTail(int64_t value) { this->weightPreBlockTail = value; }
    void set_softmaxOutPreBlockFactor(int64_t value) { this->softmaxOutPreBlockFactor = value; }
    void set_softmaxOutPreBlockTotal(int64_t value) { this->softmaxOutPreBlockTotal = value; }
    void set_softmaxOutPreBlockTail(int64_t value) { this->softmaxOutPreBlockTail = value; }
    ...
    void set_kPostBlockTail(int64_t value) { this->kPostBlockTail = value; }
};

class DLIKGradInitOutputParamsRegbase {
public:
...
class DLIKGradVecApiParamsRegbase {
public:
    SoftMaxTiling softmaxYTilingData;
    SoftMaxTiling simpleSoftmaxPTilingData;
};

class DenseLightningIndexerGradRegBaseTilingData {
public:
    DLIKGradBaseParamsRegbase baseParams;
    DLIKGradMultiCoreParamsRegbase multiCoreParams;
    DLIKGradInitOutputParamsRegbase initOutputParams;
    DLIKGradVecApiParamsRegbase vectorParams;
};
} // namespace optiling
#endif // DENSE_LIGHTNING_INDEXER_KL_LOSS_GRAD_TILING_H
