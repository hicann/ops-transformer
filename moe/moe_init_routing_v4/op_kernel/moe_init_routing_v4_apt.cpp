                                                           ...
                                                           GM_ADDR workspace, GM_ADDR tiling)
{
    ...
    if (t->isInputTopkWeight == 1) {
        ...
        topkWeightOp.Init(topkWeight, expandedRowIdx, expandedTopkWeight,
                          userWS, t, &topkWeightPipe);
