...
std::vector<gert::TilingContextPara::TensorDescription> BuildV4Inputs(
    ...
    bool hasActiveNum, int64_t activeNumVal, bool hasTopkWeight, int64_t totalLength)
{
...
std::vector<gert::TilingContextPara::TensorDescription> BuildV4Outputs(
    ...
    const ExpandedScaleDesc &expandedScale, bool hasExpandedTopkWeight, int64_t n, int64_t k,
    int64_t dropPadMode, int64_t expertNum, int64_t expertCapacity)
{
    std::vector<gert::TilingContextPara::TensorDescription> outputDesc;
    if (dropPadMode == 1) {
        outputDesc.emplace_back(gert::StorageShape({expertNum, expertCapacity, h}, {expertNum, expertCapacity, h}), expandedXDtype, ge::FORMAT_ND);
    } else {
...
std::vector<gert::TilingContextPara::OpAttr> BuildV4Attrs(
...
gert::TilingContextPara MakeV4TilingContextPara(
    ...
    bool hasActiveNum, int64_t activeNumVal, bool hasTopkWeight,
    optiling::MoeInitRoutingV3CompileInfo *compileInfo)
{
    ...
    auto inputDesc = BuildV4Inputs(n, h, k, xDataType, scaleShape, scaleDtype, offsetShape, offsetDtype,
                                   hasActiveNum, activeNumVal, hasTopkWeight, totalLength);
    auto outputDesc = BuildV4Outputs(totalLength, h, expandedXDtype, expertTokensShape, expandedScale,
                                     hasTopkWeight, n, k, dropPadMode, expertNum, expertCapacity);
    auto attrs = BuildV4Attrs(expertCapacity, expertNum, dropPadMode, expertTokensNumType,
                              expertTokensNumFlag, quantMode, aciveExpertRange, rowIdxType);
    return gert::TilingContextPara("MoeInitRoutingV4", inputDesc, outputDesc, attrs, compileInfo, "Ascend950", A5SocInfo,
                                   4096);
}
...
void RunV4Testcase(int64_t N, int64_t H, int64_t K, int64_t expertCapacity, int64_t dropPadMode,
                   ...
                   ge::DataType expandedXDtypeOverride, bool hasActiveNum, int64_t activeNumVal,
                   bool hasTopkWeight, ge::graphStatus expectResult,
...
{
    int64_t h = 83;
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_UNQUANT, ge::DT_FLOAT16,
                  {180, 192}, ROW_IDX_TYPE_GATHER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT, kExpandedXDtypeAuto,
                  false, 0, false, ge::GRAPH_SUCCESS);
}
...
{
    int64_t h = 83;
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_DYNAMIC, ge::DT_FLOAT,
                  {180, 192}, ROW_IDX_TYPE_GATHER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT, kExpandedXDtypeAuto,
                  false, 0, false, ge::GRAPH_SUCCESS);
}
...
TEST_F(MoeInitRoutingV4Tiling, moe_init_routing_v4_tiling_fullload_dynamic_with_topkweight)
{
    ...
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_DYNAMIC, ge::DT_FLOAT,
                  {180, 192}, ROW_IDX_TYPE_GATHER, {expertRange, h}, ge::DT_FLOAT, {}, ge::DT_FLOAT, kExpandedXDtypeAuto,
                  false, 0, true, ge::GRAPH_SUCCESS);
}
...
{
    int64_t h = 60;
    RunV4Testcase(8, h, 32, 0, 0, EXPERT_TOKENS_TYPE_KEY_VALUE, true, QUANT_MODE_UNQUANT, ge::DT_FLOAT16,
                  {0, 100}, ROW_IDX_TYPE_SCATTER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT, kExpandedXDtypeAuto,
                  false, 0, false, ge::GRAPH_SUCCESS);
}
...
{
    int64_t h = 60;
    RunV4Testcase(8, h, 32, 0, 0, EXPERT_TOKENS_TYPE_KEY_VALUE, true, QUANT_MODE_DYNAMIC, ge::DT_BF16,
                  {0, 100}, ROW_IDX_TYPE_SCATTER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT, kExpandedXDtypeAuto,
                  false, 0, true, ge::GRAPH_SUCCESS);
}
...
TEST_F(MoeInitRoutingV4Tiling, moe_init_routing_v4_tiling_droppad_unquant_with_topkweight)
{
    RunV4Testcase(1000000, 16, 1, 1, 1, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_UNQUANT, ge::DT_FLOAT,
                  {0, EXPERT_NUM}, ROW_IDX_TYPE_GATHER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT, kExpandedXDtypeAuto,
                  false, 0, true, ge::GRAPH_SUCCESS);
}
...
{
    RunV4Testcase(4, 16, 2, 2, 1, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_UNQUANT, ge::DT_FLOAT,
                  {0, EXPERT_NUM}, ROW_IDX_TYPE_SCATTER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT, kExpandedXDtypeAuto,
                  false, 0, false, ge::GRAPH_FAILED);
}
...
{
    int64_t h = 83;
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_MXFP8_E5M2, ge::DT_FLOAT16,
                  {180, 192}, ROW_IDX_TYPE_GATHER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT, kExpandedXDtypeAuto,
                  false, 0, false, ge::GRAPH_SUCCESS);
}
...
{
    int64_t h = 83;
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_MXFP8_E4M3FN, ge::DT_BF16,
...
{
    int64_t h = 65;
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_MXFP8_ROUNDSCALE_AMAX_E5M2,
                  ge::DT_FLOAT16, {180, 192}, ROW_IDX_TYPE_GATHER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT,
                  kExpandedXDtypeAuto, false, 0, false, ge::GRAPH_SUCCESS);
}
...
{
    int64_t h = 97;
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_MXFP8_ROUNDSCALE_AMAX_E4M3FN,
...
{
    int64_t h = 83;
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_MXFP4_E2M1, ge::DT_FLOAT16,
                  {180, 192}, ROW_IDX_TYPE_GATHER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT, kExpandedXDtypeAuto,
                  false, 0, false, ge::GRAPH_SUCCESS);
}
...
{
    int64_t h = 83;
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_FP8_PERBLOCK_E5M2,
                  ge::DT_FLOAT16, {180, 192}, ROW_IDX_TYPE_GATHER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT,
                  kExpandedXDtypeAuto, false, 0, false, ge::GRAPH_SUCCESS);
}
...
{
    int64_t h = 83;
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_FP8_PERBLOCK_E4M3FN,
                  ge::DT_BF16, {180, 192}, ROW_IDX_TYPE_SCATTER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT,
                  kExpandedXDtypeAuto, false, 0, false, ge::GRAPH_SUCCESS);
}
...
{
    int64_t h = 257;
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_FP8_GROUP_E5M2,
                  ge::DT_FLOAT16, {180, 192}, ROW_IDX_TYPE_GATHER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT,
                  kExpandedXDtypeAuto, false, 0, false, ge::GRAPH_SUCCESS);
}
...
{
    int64_t h = 257;
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_FP8_GROUP_E4M3FN,
                  ge::DT_BF16, {180, 192}, ROW_IDX_TYPE_SCATTER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT,
                  kExpandedXDtypeAuto, false, 0, false, ge::GRAPH_SUCCESS);
}
...
{
    int64_t h = 257;
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_FP8_GROUP_AMAX_E5M2,
                  ge::DT_FLOAT16, {180, 192}, ROW_IDX_TYPE_GATHER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT,
                  kExpandedXDtypeAuto, false, 0, false, ge::GRAPH_SUCCESS);
}
...
{
    int64_t h = 257;
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_FP8_GROUP_AMAX_E4M3FN,
                  ge::DT_BF16, {180, 192}, ROW_IDX_TYPE_SCATTER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT,
                  kExpandedXDtypeAuto, false, 0, false, ge::GRAPH_SUCCESS);
}
...
{
    int64_t h = 83;
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_UNQUANT,
                  ge::DT_FLOAT8_E5M2, {180, 192}, ROW_IDX_TYPE_GATHER, {1, 2, 2},
                  ge::DT_FLOAT8_E8M0, {}, ge::DT_FLOAT, kExpandedXDtypeAuto, false, 0, false, ge::GRAPH_SUCCESS);
}
...
TEST_F(MoeInitRoutingV4Tiling, moe_init_routing_v4_tiling_dynamic_with_scale)
{
    int64_t h = 83;
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_DYNAMIC, ge::DT_FLOAT,
                  {180, 192}, ROW_IDX_TYPE_GATHER, {12, h}, ge::DT_FLOAT, {}, ge::DT_FLOAT,
                  kExpandedXDtypeAuto, false, 0, false, ge::GRAPH_SUCCESS);
}
...
{
    int64_t h = 84;
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_INT4_DYNAMIC, ge::DT_FLOAT,
                  {180, 192}, ROW_IDX_TYPE_GATHER, {1, h}, ge::DT_FLOAT, {}, ge::DT_FLOAT,
                  kExpandedXDtypeAuto, false, 0, false, ge::GRAPH_SUCCESS);
}
...
{
    int64_t h = 83;
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_STATIC, ge::DT_FLOAT,
...
{
    int64_t h = 83;
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_HIF8_CAST, ge::DT_FLOAT16,
                  {180, 192}, ROW_IDX_TYPE_GATHER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT, kExpandedXDtypeAuto,
                  false, 0, false, ge::GRAPH_SUCCESS);
}
...
{
    int64_t h = 83;
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_HIF8_PERTOKEN, ge::DT_BF16,
                  {180, 192}, ROW_IDX_TYPE_SCATTER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT, kExpandedXDtypeAuto,
                  false, 0, false, ge::GRAPH_SUCCESS);
}
...
{
    int64_t h = 60;
    RunV4Testcase(8, h, 32, 0, 0, EXPERT_TOKENS_TYPE_KEY_VALUE, true, QUANT_MODE_MXFP8_E5M2,
...
{
    RunV4Testcase(1, 83, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_STATIC, ge::DT_FLOAT,
...
{
    RunV4Testcase(1, 83, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_INT4_DYNAMIC, ge::DT_FLOAT,
                  {180, 192}, ROW_IDX_TYPE_GATHER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT,
                  kExpandedXDtypeAuto, false, 0, false, ge::GRAPH_FAILED);
}

// MXFP4 unsupported x dtype -> fail
TEST_F(MoeInitRoutingV4Tiling, moe_init_routing_v4_tiling_mxfp4_bad_xdtype)
{
    RunV4Testcase(1, 83, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_MXFP4_E2M1, ge::DT_FLOAT,
                  {180, 192}, ROW_IDX_TYPE_GATHER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT, kExpandedXDtypeAuto,
                  false, 0, false, ge::GRAPH_FAILED);
}
...
{
    RunV4Testcase(1, 84, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_INT4_DYNAMIC, ge::DT_FLOAT16,
                  {180, 192}, ROW_IDX_TYPE_GATHER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT,
                  kExpandedXDtypeAuto, false, 0, false, ge::GRAPH_FAILED);
}
...
{
    RunV4Testcase(1, 83, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_UNQUANT,
                  ge::DT_FLOAT8_E5M2, {180, 192}, ROW_IDX_TYPE_GATHER, {1, 2, 2}, ge::DT_FLOAT, {},
                  ge::DT_FLOAT, kExpandedXDtypeAuto, false, 0, false, ge::GRAPH_FAILED);
}

// empty tensor: n==0
TEST_F(MoeInitRoutingV4Tiling, moe_init_routing_v4_tiling_empty_tensor_n_zero)
{
    RunV4Testcase(0, 128, 8, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_UNQUANT,
                  ge::DT_FLOAT, {0, EXPERT_NUM}, ROW_IDX_TYPE_GATHER, {}, ge::DT_FLOAT, {},
                  ge::DT_FLOAT, kExpandedXDtypeAuto, false, 0, false, ge::GRAPH_SUCCESS);
}

// empty tensor: k==0
TEST_F(MoeInitRoutingV4Tiling, moe_init_routing_v4_tiling_empty_tensor_k_zero)
{
    RunV4Testcase(3, 128, 0, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_UNQUANT,
                  ge::DT_FLOAT, {0, EXPERT_NUM}, ROW_IDX_TYPE_GATHER, {}, ge::DT_FLOAT, {},
                  ge::DT_FLOAT, kExpandedXDtypeAuto, false, 0, false, ge::GRAPH_SUCCESS);
}
...
{
    RunV4Testcase(3, 0, 8, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_UNQUANT,
                  ge::DT_FLOAT, {0, EXPERT_NUM}, ROW_IDX_TYPE_GATHER, {}, ge::DT_FLOAT, {},
                  ge::DT_FLOAT, kExpandedXDtypeAuto, false, 0, false, ge::GRAPH_SUCCESS);
}
...
{
    RunV4Testcase(3, 64, 0, 0, 0, EXPERT_TOKENS_TYPE_KEY_VALUE, true, QUANT_MODE_UNQUANT,
...
TEST_F(MoeInitRoutingV4Tiling, moe_init_routing_v4_tiling_active_num_input_present)
{
    ...
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_UNQUANT, ge::DT_FLOAT16,
                  {180, 192}, ROW_IDX_TYPE_GATHER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT, kExpandedXDtypeAuto,
                  true, 27, false, ge::GRAPH_SUCCESS);
}
...
{
    int64_t h = 83;
    RunV4Testcase(1, h, 27, 0, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_UNQUANT, ge::DT_FLOAT,
                  {180, 192}, ROW_IDX_TYPE_SCATTER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT, kExpandedXDtypeAuto,
                  true, 27, true, ge::GRAPH_SUCCESS);
}
...
TEST_F(MoeInitRoutingV4Tiling, moe_init_routing_v4_tiling_multicore_dynamic_active_topkweight)
{
    ...
    RunV4Testcase(8, h, 32, 0, 0, EXPERT_TOKENS_TYPE_KEY_VALUE, true, QUANT_MODE_DYNAMIC, ge::DT_BF16,
                  {0, 100}, ROW_IDX_TYPE_SCATTER, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT, kExpandedXDtypeAuto,
                  true, 256, true, ge::GRAPH_SUCCESS);
}
...
TEST_F(MoeInitRoutingV4Tiling, moe_init_routing_v4_tiling_topk_weight_invalid_dtype)
{
    ...
    int64_t k = 27;
    int64_t totalLength = n * k;
    auto inputDesc = BuildV4Inputs(n, h, k, ge::DT_FLOAT16, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT, false, 0, true, totalLength);
    auto outputDesc = BuildV4Outputs(totalLength, h, ge::DT_FLOAT16, {EXPERT_NUM - 180}, {{totalLength}, ge::DT_FLOAT},
                                     true, n, k, 0, EXPERT_NUM, 0);
    auto attrs = BuildV4Attrs(0, EXPERT_NUM, 0, EXPERT_TOKENS_TYPE_COUNT, true, QUANT_MODE_UNQUANT, {180, 192}, ROW_IDX_TYPE_GATHER);
    gert::TilingContextPara tilingContextPara("MoeInitRoutingV4", inputDesc, outputDesc, attrs, &compileInfo, "Ascend950", A5SocInfo, 4096);
...
TEST_F(MoeInitRoutingV4Tiling, moe_init_routing_v4_tiling_active_num_invalid_dtype)
{
    ...
    int64_t k = 27;
    int64_t totalLength = n * k;
    auto inputDesc = BuildV4Inputs(n, h, k, ge::DT_FLOAT16, {}, ge::DT_FLOAT, {}, ge::DT_FLOAT, false, 0, false, totalLength);
