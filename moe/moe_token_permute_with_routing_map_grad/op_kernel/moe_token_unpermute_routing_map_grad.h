...
/*!
 * \file moe_token_unpermute_routing_map_grad.h
 * \brief
 */
#ifndef MOE_TOKEN_UNPERMUTE_ROUTING_MAP_GRAD
#define MOE_TOKEN_UNPERMUTE_ROUTING_MAP_GRAD
...
#endif // MOE_TOKEN_UNPERMUTE_ROUTING_MAP_GRAD
