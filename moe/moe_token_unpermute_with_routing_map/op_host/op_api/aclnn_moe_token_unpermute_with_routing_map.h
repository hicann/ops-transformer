...
 */
#ifndef OP_API_INC_MOE_TOKEN_UNPERMUTE_WITH_ROUTING_MAP_H_
#define OP_API_INC_MOE_TOKEN_UNPERMUTE_WITH_ROUTING_MAP_H_
 ...
 * @param [out] permuteProbs: 计算输出，Tensor，可选输出，数据类型float16,
 ...
 *
 */
ACLNN_API aclnnStatus aclnnMoeTokenUnpermuteWithRoutingMapGetWorkspaceSize(
 ...
 * device侧申请的workspace大小，由第一段接口aclnnMoeTokenUnpermuteWithRoutingMapGetWorkspaceSize获取。
 * @param [in] executor: op执行器，包含了算子计算流程。
 * @param [in] stream: acl stream流。
 * @return aclnnStatus: 返回状态码
 */

ACLNN_API aclnnStatus aclnnMoeTokenUnpermuteWithRoutingMap(void *workspace, uint64_t workspaceSize,
