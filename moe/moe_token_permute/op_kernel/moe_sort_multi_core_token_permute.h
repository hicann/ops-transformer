...
/*!
 * \file moe_sort_multi_core_token_permute.h
 * \brief
 */
#ifndef MOE_SORT_MULTI_CORE_TOKEN_PERMUTE_H
#define MOE_SORT_MULTI_CORE_TOKEN_PERMUTE_H

#include "moe_sort_base_token_permute.h"
