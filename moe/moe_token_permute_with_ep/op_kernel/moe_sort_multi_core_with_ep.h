...
/*!
 * \file moe_sort_multi_core_with_ep.h
 * \brief
 */
#ifndef MOE_SORT_MULTI_CORE_WITH_EP_H
#define MOE_SORT_MULTI_CORE_WITH_EP_H

#include "moe_sort_base_with_ep.h"
#include "moe_mrgsort_with_ep.h"
#include "moe_mrgsort_out_with_ep.h"
