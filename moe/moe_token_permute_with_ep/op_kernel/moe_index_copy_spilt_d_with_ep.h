...
/*!
 * \file moe_index_copy_spilt_d_with_ep.h
 * \brief
 */
#ifndef MOE_INDEX_COPY_SPILT_D_WITH_EP_H
#define MOE_INDEX_COPY_SPILT_D_WITH_EP_H
...
#endif // MOE_INDEX_COPY_SPILT_D_WITH_EP_H