...
/*!
 * \file inplace_partial_rotary_mul_a_and_b.h
 * \brief
 */
#ifndef INPLACE_PARTIAL_ROTARY_MUL_A_AND_B_H
#define INPLACE_PARTIAL_ROTARY_MUL_A_AND_B_H
