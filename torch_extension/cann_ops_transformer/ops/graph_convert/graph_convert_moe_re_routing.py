...
if _TORCHAIR_AVAILABLE:
    ...
    def MoeReRouting(tokens: Tensor, expert_token_num_per_rank: Tensor,
                      per_token_scales: Optional[Tensor], expert_topk_weight: Optional[Tensor], *,
                      expert_token_num_type: int, idx_type: int,
        ...
        return ge_op(
            ...
            .input("tokens", "DT_FLOAT16, DT_BF16, DT_INT8, DT_FLOAT8_E5M2, DT_FLOAT8_E4M3FN, "
                   "DT_HIFLOAT8, DT_FLOAT4_E2M1, DT_FLOAT4_E1M2") \
            ...
            .output("permute_tokens", "DT_FLOAT16, DT_BF16, DT_INT8, DT_FLOAT8_E5M2, DT_FLOAT8_E4M3FN, "
                    "DT_HIFLOAT8, DT_FLOAT4_E2M1, DT_FLOAT4_E1M2") \
    ...
    @register_fx_node_ge_converter(torch.ops.cann_ops_transformer.moe_re_routing.default)
    def convert_moe_re_routing(
        ...
        *,
        ...
        permute_tokens, permute_per_token_scales, permute_token_idx, expert_token_num, permute_topk_weight = \
            MoeReRouting(tokens, expert_token_num_per_rank, per_token_scales, expert_topk_weight,
        ...
        return permute_tokens, permute_per_token_scales, permute_token_idx, expert_token_num, permute_topk_weight
