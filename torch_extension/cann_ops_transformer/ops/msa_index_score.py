...
class MsaIndexScoreOpBuilder(OpBuilder):
    def __init__(self):
        super(MsaIndexScoreOpBuilder, self).__init__("msa_index_score")

    def sources(self):
        return ["ops/csrc/msa_index_score.cpp"]
...
@impl(AS_LIBRARY, _msa_index_score_op_builder.name, "PrivateUse1")
