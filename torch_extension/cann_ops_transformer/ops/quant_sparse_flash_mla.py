...
class QuantSparseFlashMlaOpBuilder(OpBuilder):
    ...
    def sources(self):
        ...
        return ["ops/csrc/quant_sparse_flash_mla.cpp"]
...
@impl(AS_LIBRARY, QSMLA_METADATA_OP_NAME, "PrivateUse1")
...
@impl(AS_LIBRARY, quant_sparse_flash_mla_op_builder.name, "PrivateUse1")
