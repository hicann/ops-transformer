...
/*!
 * \file block_attention_residuals_def.cpp
 * \brief BlockAttentionResiduals operator definition
 */
#include "register/op_def_registry.h"

namespace ops {
class BlockAttentionResiduals : public OpDef {
public:
    explicit BlockAttentionResiduals(const char *name) : OpDef(name)
    {
        ...
        config_950.DynamicCompileStaticFlag(true)
            ...
            .DynamicShapeSupportFlag(true)
            .NeedCheckSupportFlag(false)
            .ExtendCfgInfo("opFile.value", "block_attention_residuals_apt");
        this->AICore().AddConfig("ascend950", config_950);
    }
};

OP_ADD(BlockAttentionResiduals);
} // namespace ops
