...
#ifndef VF_SOFTMAX_DN_CAST_NZ_MXFP4_ALIGN_QS128_KVS32_MULTI_MASK_H_
#define VF_SOFTMAX_DN_CAST_NZ_MXFP4_ALIGN_QS128_KVS32_MULTI_MASK_H_
...
__simd_callee__ inline void softmax_align_qs128_kvs32_multi_chunk_vf(__ubuf__ T2 *p_dest, __ubuf__ T *s,
...
template <MXQuantMode MX_QUANT_MODE = MXQuantMode::OCP, bool clear_gmax, typename T, typename T2, uint16_t QsBase = 128>
__simd_vf__ inline void softmax_align_qs128_kvs32_multi_chunk_only_vf(
...
{
    softmax_align_qs128_kvs32_multi_chunk_vf<MX_QUANT_MODE, clear_gmax, T, T2, QsBase>(
        p_dest, s, local_group_max, global_max, indexes_ub, NEG_LOG2_CX, chunkY, effY, true, rows);
}

template <MXQuantMode MX_QUANT_MODE = MXQuantMode::OCP, bool clear_gmax, typename T, typename T2, uint16_t QsBase = 128>
__aicore__ inline void SoftmaxWithGroupMaxAlignQs128Kvs32MultiChunkCallVF(
    ...
    const uint16_t effY, const uint16_t rows)
{
    ...
    softmax_align_qs128_kvs32_multi_chunk_only_vf<MX_QUANT_MODE, clear_gmax, T, T2, QsBase>(
        p_dest, s_ub, local_group_max, global_max, indexes_ub, NEG_LOG2_CX, chunkY, effY, rows);
}

} // namespace NpuArch::Epilogue::Block::Mxfp4VF
#endif // VF_SOFTMAX_DN_CAST_NZ_MXFP4_ALIGN_QS128_KVS32_MULTI_MASK_H_
