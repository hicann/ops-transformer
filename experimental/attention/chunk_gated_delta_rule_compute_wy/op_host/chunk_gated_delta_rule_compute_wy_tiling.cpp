                                      ...
                                      TCubeTiling &out, bool abFromUb = false)
{
    ...
    mm.SetAType(abPos, matmul_tiling::CubeFormat::ND, matmul_tiling::DataType::DT_FLOAT16, false);
    mm.SetBType(abPos, matmul_tiling::CubeFormat::ND, matmul_tiling::DataType::DT_FLOAT16, bTranspose);
    ...
    mm.SetShape(std::min<int64_t>(m, FIXED_CHUNK), std::min<int64_t>(n, FIXED_CHUNK),
