    ...
    const aclTensor *uKernelOut, const aclTensor *gKernelOut, aclOpExecutor *executor)
{
    ...
    auto ret = ADD_TO_LAUNCHER_LIST_AICORE(ChunkGatedDeltaRuleComputeWy, OP_INPUT(q, k, v, g, beta),
                                           OP_OUTPUT(qKernelOut, kKernelOut, wKernelOut, uKernelOut, gKernelOut),
                                           OP_ATTR(chunkSize));
