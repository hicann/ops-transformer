...
const std::array<const aclTensor *, 1> GenericBlockSparseAttention(
    ...
    int64_t softmaxPrecision, const aclTensor *attentionOut, aclOpExecutor *executor)
{
    L0_DFX(GenericBlockSparseAttention, query, key, value, sparseBlockIdx, sparseBlockCount, metadataOptional,
           qDequantScaleOptional, kDequantScaleOptional, vDequantScaleOptional, cuSeqLengthsQOptional,
           cuSeqLengthsKvOptional, sequsedQOptional, sequsedKvOptional, blockTableOptional, blockShape, isPackedGQA,
           layoutQ, layoutKv, scaleValue, maskType, softmaxPrecision);
    ...
    auto ret = INFER_SHAPE(
        ...
        OP_INPUT(query, key, value, sparseBlockIdx, sparseBlockCount, metadataOptional, qDequantScaleOptional,
        ...
        OP_ATTR(blockShape, static_cast<int64_t>(isPackedGQA), layoutQ, layoutKv, static_cast<float>(scaleValue),
                static_cast<int64_t>(maskType), static_cast<int64_t>(softmaxPrecision)));
