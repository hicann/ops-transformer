...
- **key**: Key tensor,支持以下布局
  ...
  - BNSD: [batch, num_kv_heads, kv_seq_len, head_dim]
...
对于qSeqLength=512, kvSeqLength=1024, blockShapeX=128, blockShapeY=128:
...
9. 当前不支持PagedAttention，blockTableOptional当前只支持传入空指针。
