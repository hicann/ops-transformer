...
def compressor(testcase_files):  # 初始化参数和tensor
    ...
    row_data = {
        ...
        "seqused": params[10],
        "start_pos": params[11],
        "x_datarange": params[12],
        "wkv_datarange": params[13],
        "wgate_datarange": params[14],
        "kv_state_datarange": params[15],
        "score_state_datarange": params[16],
        "result": result,
