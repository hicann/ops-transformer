...
public:
    ...
    __aicore__ inline
    MinimaxSparseAttentionSplitKvKernelArch35() {}

    __aicore__ inline
    void operator()(MinimaxSaSplitKvKernelParamsArch35 const &params)
    {
                              ...
                              uint32_t dstStride)
    {
        ...
        AscendC::DataCopyPad(
            ...
            AscendC::DataCopyExtParams{
                blockCount, static_cast<uint16_t>(rowCount * sizeof(float)),
